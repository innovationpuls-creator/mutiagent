...
| 模块 | 能做什么 |
| :--- | :--- |
| 学习画像 | 破冰对话采集学习目标、基础与偏好 |
| 学习路径 | 按年生成路径，查看当前课程与相邻节点 |
| 课程学习 | 图文讲解、教学视频、HTML 交互动画 |
| 章节测验 | 在线作答、批改结果与薄弱点展示 |
| AI 成长报告 | 累计回顾，优势、巩固项与建议，依据可展开追溯 |
...
| :--- | :--- |
| 培养方案 | 导入与发布培养方案 |
| 账号与数据 | 维护账号、组织班级、查看学习数据 |
| 教材知识库 | 教材上传、解析详情、大纲确认与发布 |
