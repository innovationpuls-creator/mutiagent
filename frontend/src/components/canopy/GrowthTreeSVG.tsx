...
export function GrowthTreeSVG({ stage }: GrowthTreeSVGProps) {
	...
	return (
		...
		>
			...
			<circle
				className="tree-stage layer-ground is-visible"
				cx="120"
				cy="168"
				r="78"
				fill="url(#tree-ground-glow)"
			/>
			<ellipse
				className="tree-stage layer-ground is-visible"
				cx="120"
			...
			<g
				className={`tree-stage layer-branches ${stageVisible(visibleStage, 3)}`}
			>
				<path
			...
			<g
				className={`tree-stage layer-leaves canopy-breathe ${stageVisible(visibleStage, 4)}`}
			>
			...
			<g className={`tree-stage layer-grove ${stageVisible(visibleStage, 5)}`}>
				<path
					d="M48 186 C46 167 48 150 54 131"
					fill="none"
					stroke="oklch(57% 0.07 62 / 0.58)"
					strokeWidth="8"
					strokeLinecap="round"
				/>
				<ellipse
					...
					rx="24"
					ry="22"
					fill="oklch(75% 0.08 135 / 0.58)"
				/>
				<path
					d="M198 188 C198 168 202 151 208 134"
					fill="none"
					stroke="oklch(57% 0.07 62 / 0.52)"
					strokeWidth="8"
					strokeLinecap="round"
				/>
				<ellipse
					...
					rx="25"
					ry="22"
					fill="oklch(73% 0.08 135 / 0.52)"
				/>
			</g>

			<g
				className={`tree-stage layer-bloom canopy-breathe ${stageVisible(visibleStage, 6)}`}
			>
				...
				<path
					d="M61 52 L64 59 L71 62 L64 65 L61 72 L58 65 L51 62 L58 59Z"
					fill="oklch(84% 0.08 58)"
				/>
				<path
					d="M189 45 L192 51 L198 54 L192 57 L189 63 L186 57 L180 54 L186 51Z"
					fill="oklch(84% 0.08 58)"
				/>
				<path
					d="M201 137 L204 143 L210 146 L204 149 L201 155 L198 149 L192 146 L198 143Z"
					fill="oklch(84% 0.08 58)"
				/>
			</g>
		</svg>
