...
import { whisperVariants, breathingGlowVariants } from '../../lib/motion';
...
export function NodeLearningView({ nodeId, title, agentMessage, onClose, markdownContent }: NodeLearningViewProps) {
