			...
			{options.map((option) => {
				...
				return (
					<motion.button
						...
						whileHover={
							reduceMotion || isDisabled ? undefined : { y: -2, scale: 1.015 }
						}
						whileTap={
							reduceMotion || isDisabled ? undefined : { y: 0, scale: 0.992 }
						}
						...
						style={{
							...
							boxShadow: isActive
								? "0 8px 20px oklch(49% 0.05 235 / 0.16)"
								: "none",
							transition:
								"color 300ms ease, opacity 300ms ease, box-shadow 300ms ease",
						}}
					>
						{isActive && (
							<motion.div
								...
								style={{
									...
									boxShadow:
										"inset 0 1px 1px oklch(100% 0 0 / 0.25), 0 4px 12px oklch(49% 0.05 235 / 0.2)",
								}}
								transition={motionTokens.lazy}
							/>
						)}
