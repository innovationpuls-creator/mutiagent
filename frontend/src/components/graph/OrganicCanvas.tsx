    ...
    const observer = new ResizeObserver((entries) => {
      ...
      entries.forEach((entry) => {
        ...
        if (id) {
          ...
          if (newSizes[id]?.width !== width || newSizes[id]?.height !== height) {
  ...
  return (
    <div className="organic-canvas-root">
      ...
      <svg className="organic-svg-layer">
        ...
        {layout && layout.layoutEdges.map(edge => {
          const sourceNode = layout.layoutNodes.find(n => n.id === edge.source);
          const targetNode = layout.layoutNodes.find(n => n.id === edge.target);
          ...
          return (
            <motion.div
              ...
              animate={layoutNode ? { 
                ...
                opacity: 1 
              } : { opacity: 0 }} // Hidden until measured and calculated
