import { isCourseKnowledgeResult, type CourseKnowledgeResult, type CourseNode, type LearningPathResult } from './chat';
...
function isTimeArrangement(value: unknown): value is CourseNode['time_arrangement'] {
...
function isCurrentLearningCourse(
  ...
  return isRecord(value)
    ...
    && (value.progress_state === 'in_progress' || value.progress_state === 'completed')
...
export function isProfileDashboardData(value: unknown): value is ProfileDashboardData {
  return isRecord(value)
